...
export default function DistractorShape({ cell }: { cell: DisplayCell }) {
  ...
  const common = { className, viewBox: '0 0 32 32' as const, fill: 'none' as const, stroke: SHAPE_STROKE };
  switch (cell.type) {
    case 'TRI':
      return (
        <svg className="distractor distractor-svg" viewBox="0 0 32 32" fill="none" stroke={SHAPE_STROKE} strokeWidth={3} strokeLinecap="round">

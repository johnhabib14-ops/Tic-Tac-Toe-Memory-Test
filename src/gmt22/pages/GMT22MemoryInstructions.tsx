  ...
  return (
    <div className="page">
      ...
      <p className="subtitle">
        You&apos;ll see a grid, then it disappears. Place the same symbols in the same spots in the empty grid. There&apos;s a time limit.
      </p>
      <p>
      ...
      <ul style={{ textAlign: 'left', maxWidth: '32rem', margin: '0 auto 1.5rem', lineHeight: 1.6 }}>
        <li><strong style={{ color: '#1f77b4' }}>Ignore +</strong> (blue) — Only place X and O.</li>
        <li><strong style={{ color: '#ff7f0e' }}>Remember +</strong> (orange) — Place X, O, and +.</li>
      </ul>

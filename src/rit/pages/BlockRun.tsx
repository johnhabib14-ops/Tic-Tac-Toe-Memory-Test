...
import type { BlockType, RITPhase, TrialRecord } from '../types';
...
export default function BlockRun({ blockType, nextPhase, title }: Props) {
  ...
  const intro =
    blockType === 'practice'
      ? copy.practiceIntro
      : copy.betweenBlocks[blockType as 'baseline' | 'habit' | 'standard' | 'interference'] ??
        copy.scoredStart;
  ...
  return (
    ...
    >
      <div className="page rit-page rit-block-page">
        {!running ? (
          <>

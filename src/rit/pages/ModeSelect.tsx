    ...
    >
      <div className="page rit-page">
        ...
        {inFullBattery && !isDemo && (
          <p className="hl-demo-badge" role="status">
            Full battery — task 2 of 3. Full protocol length.
          </p>
        )}
        {linked && linkCtx && (
          <p className="hl-demo-badge" role="status">
        ...
        <div className="rit-mode-grid">
          <label className="rit-field">
            ...
            >
              ...
              <option value="game">Game Mode (Signal Gate)</option>
            </select>
          </label>
        </div>
        ...
        {quickStart ? (
          ...
          <div className="rit-admin-options">
            {options.map((o) => (
              <button
                key={o.admin}
                type="button"
                className="rit-option-btn"
